...
from .views import (
    ...
    ConfirmRegistrationView, ResendConfirmationView,
)
...
urlpatterns = [
    ...
    path('auth/confirmer-inscription/', ConfirmRegistrationView.as_view(), name='confirmer_inscription'),
    path('auth/renvoyer-code/', ResendConfirmationView.as_view(), name='renvoyer_code'),
